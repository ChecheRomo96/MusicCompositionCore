...
using namespace MusicCompositionCore::MusicalNote;

Pitch::Letter MusicCompositionCore::MusicalNote::Pitch::Letter::Buffer;
...
MusicCompositionCore::MusicalNote::Pitch::Letter::operator const LetterType() const{return _ID;}

bool MusicCompositionCore::MusicalNote::operator < (const Pitch::Letter &lhs, const Pitch::Letter &rhs)
{
...
bool MusicCompositionCore::MusicalNote::operator == (const Pitch::Letter::LetterType &lhs, const Pitch::Letter &rhs)
{
    if(Pitch::Letter(lhs).ID() == rhs.ID()){return 1;}
    return 0;
}

bool MusicCompositionCore::MusicalNote::operator == (const Pitch::Letter &lhs, const Pitch::Letter::LetterType &rhs)
{
...
MusicCompositionCore::MusicalNote::Pitch& Pitch::Letter::GenerateToken(const Pitch::Accidental& source)
{
