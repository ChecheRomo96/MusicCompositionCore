...
Pitch::Accidental MusicCompositionCore::MusicalNote::Pitch::Accidental::Buffer;
...
// Operadores
	...
	//
		...
		bool MusicCompositionCore::MusicalNote::operator < (const Pitch::Accidental &lhs, const Pitch::Accidental &rhs)
		{
		    if(lhs.ID() < rhs.ID()){return 1;}
		    return 0;
		}

		bool MusicCompositionCore::MusicalNote::operator < (const Pitch::Accidental::AccidentalType &lhs, const Pitch::Accidental &rhs)
		{
		    if(lhs < rhs.ID()){return 1;}
		    return 0;
		}

		bool MusicCompositionCore::MusicalNote::operator < (const Pitch::Accidental &lhs, const Pitch::Accidental::AccidentalType &rhs)
		{
