...
#define MCC_NOTE_CLASS_H
	...
	//struct MusicCompositionCore::MidiCore::MidiNote;
			...
			class Note
			{
				...
				public:
					...
					// API
						...
						const char* Name(const TextFormat& format = DefaultFormat)const;
						char* Name(char* buff, const TextFormat& format = DefaultFormat);
