...
int main()
{
    ...
    MCC_MusicalScale::Scale myScale(MCC_MusicalNote::Note(MCC_MusicalNote::Pitch::C_Natural, 3), MCC_MusicalScaleFlash::Scales::MajorPentatonic);
    std::cout << myScale.Name() << std::endl;

	MCC_MusicalNote::Note referenceNote(MCC_MusicalNote::Pitch::A_Natural, 4);
